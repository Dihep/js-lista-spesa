Obbiettivo: Data una lista della spesa, stampare gli elementi della lista individualmente con un ciclo while. Ciò permette di fare pratica con i cicli, in questo caso while.
